// /__tests__/dust-data.test.js
import { describe, it, expect, vi, beforeEach } from "vitest";
import { GET } from "../../src/app/api/dust-data/route";
...
describe("API Route: /api/dust-data", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("should return dust data successfully", async () => {
    // Mock database and rate limiting behavior
    const mockData = [{ id: 1, timestamp: "2024-11-15T00:00:00Z", value: 0.35 }];
    ...
    expect(db.any).toHaveBeenCalledWith(
      "select * FROM dust ORDER BY timestamp DESC LIMIT 1"
    );
