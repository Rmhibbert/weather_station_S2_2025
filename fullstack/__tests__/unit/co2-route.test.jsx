// /__tests__/co2-data.test.js
import { describe, it, expect, vi, beforeEach } from 'vitest';
import { GET } from '../../src/app/api/co2-data/route';
...
describe('API Route: /api/co2-data', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('should return co2 data successfully', async () => {
    // Mock database and rate limiting behavior
    const mockData = [{ id: 1, timestamp: '2024-11-15T00:00:00Z', value: 456 }];
    ...
    expect(db.any).toHaveBeenCalledWith(
      'select * FROM co2 ORDER BY timestamp DESC LIMIT 1',
    );
