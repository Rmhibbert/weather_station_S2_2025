// /__tests__/pressure-data.test.js
import { describe, it, expect, vi, beforeEach } from "vitest";
import { GET } from "../../src/app/api/pressure-data/route";
...
describe("API Route: /api/pressure-data", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("should return pressure data successfully", async () => {
    // Mock database and rate limiting behavior
    const mockData = [{ id: 1, timestamp: "2024-11-15T00:00:00Z", value: 1000 }];
