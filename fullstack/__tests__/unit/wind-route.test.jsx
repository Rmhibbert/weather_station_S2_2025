// /__tests_/wind-data.test.js
import { describe, it, expect, vi, beforeEach } from "vitest";
import { GET } from "../../src/app/api/wind-data/route";
...
describe("API Route: /api/wind-data", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("should return rainfall-measurement data successfully", async () => {
    ...
    const mockData = [{ id: 1, timestamp: "2024-11-15T00:00:00Z", value: 0.234 }];
