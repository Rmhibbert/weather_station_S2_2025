describe('Weather Site Graph Pages', () => {
    ...
    const pages = [
      { path: '/temperature', label: 'Temperature', unit: '°C', min: -20, max: 50 },
      { path: '/rain', label: 'Rainfall', unit: 'mm', min: 0, max: 100 },
      { path: '/pressure', label: 'Pressure', unit: 'hPa', min: 900, max: 1100 },
      { path: '/wind', label: 'Wind', unit: 'km/h', min: 0, max: 150 },
      { path: '/dust', label: 'Dust', unit: 'µg/m³', min: 0, max: 300 },
      { path: '/humidity', label: 'Humidity', unit: '%', min: 0, max: 100 },
    ];    
