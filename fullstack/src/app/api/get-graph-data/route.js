...
export const GET = async (request) => {
    try {
        ...
        const [table, value, length] = ['table', 'value', 'length'].map(param => searchParams.get(param));
        ...
        const isValidType = allowedTypes.some(type => type.table === table && type.value === value);
